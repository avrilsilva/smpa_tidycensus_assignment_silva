...
# After a bunch of trial and error with the API key, I was finally able to use a similar command used in class to get the median age variable and sort it by counties in Maryland. As a result, you can find that the county, or jurisdiction, with the lowest median age in Maryland is Baltimore City, Maryland. 
